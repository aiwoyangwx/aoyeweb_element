    ...
    <section>
        ...
        <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item label="客户端版本" prop="cid">
                    <el-select v-model="addForm.iid" placeholder="请选择">
                        <el-option
                ...
                <el-form-item label="运行里程" prop="runtimeMileage">
                    <el-input v-model="addForm.runtimeMileage" auto-complete="off"></el-input>
                </el-form-item>
        ...
        <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
                ...
                <el-form-item label="客户端版本" prop="cid">
                    <el-select v-model="editForm.iid" multiple placeholder="请选择">
                        <el-option
                                v-for="currentVersionNum in installers"
                                :key="currentVersionNum.id"
                                :label="currentVersionNum.versionCode"
                ...
                <el-form-item label="运行里程" prop="runtimeMileage">
                    <el-input v-model="editForm.runtimeMileage" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="国家" prop="country">
